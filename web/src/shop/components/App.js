...
const app = ({ children, shopType }) => {
  ...
  switch (shopType) {
    case 'bikes':
      shopHeadingMessage = <FormattedMessage id='Personal Details' />;
      break;
    case 'smart-phones':
      shopHeadingMessage = <FormattedMessage id='Education Details' />;
      break;
    case 'skis':
      shopHeadingMessage = <FormattedMessage id='Skills Detail' />;
      break;
  }
