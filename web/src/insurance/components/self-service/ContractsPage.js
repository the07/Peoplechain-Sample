...
class ContractsPage extends React.Component {
  ...
  render() {
    ...
    function showExpirationInfo(contract) {
      if (contract.void) {
        return (
          <FormattedMessage style={{ color: 'red' }} id='Record Signed' />
        );
      }
      return (
        <div>
        ...
        (
          <p className='ibm-ind-link'>
            <Link className='ibm-forward-link'
              ...
              <FormattedMessage id='Request Signature' />
            </Link>
          </p>
        ) : <FormattedMessage style={{ color: 'red' }} id='Record Signed' />;
        ...
        <div>
          ...
          <p className='ibm-ind-link'>
            <Link className='ibm-forward-link'
              ...
              <FormattedMessage id='View Record' />
          ...
          <div className='ibm-card ibm-border-gray-50'>
            <div className='ibm-card__content'>
              ...
              <div style={{ wordWrap: 'break-word' }}>
                <FormattedMessage id='Record' />: {contract.item.brand}<br />
                <FormattedMessage id='Organization' />: {contract.item.model}<br />
                <FormattedMessage id='Number' />: {contract.item.serialNo}
                <br />
